...
US_Stocks = {
    ...
    "헬스케어/에너지": {"일라이 릴리": "LLY", "노보 노디스크": "NVO", "존슨앤존슨": "JNJ", "머크": "MRK", "화이자": PFE: "PFE", "유나이티드헬스": "UNH", "엑슨모빌": "XOM", "셰브론": "CVX", "장인추천-XLE": "XLE"},
...
with tab3:
    ...
    with kc2:
        ...
        str_visual.info("엔비디아 밸류체인 내 HBM3E 및 차세대 제품 단독 공급 마진의 견고한 우위 확보.")
    with kc3:
...
# --- 탭 5: 올인원 마스터 뷰 (요청하신 5대 팩터 결합 16대 그리드 대확장 완성) ---
with tab5:
    ...
    # 🎯 [대복구] 요청하신 5대 팩터 ETF 리스트 완전 결합 가동
...
# --- 탭 7: 글로벌 통화정책 캘린더 (🔥 해상도 5배 대확장 스케일링 완료) ---
with tab7:
    ...
    # 🌟 [크기 5배 대확장] height를 3000px로 세팅하여 모든 국가 스케줄이 잘림 없이 뿜어져 나오도록 설계
...
# --- 탭 9: 투자 학습 일지 (오늘의 투자공부 10선 완벽 매칭 동기화 완료) ---
with tab9:
